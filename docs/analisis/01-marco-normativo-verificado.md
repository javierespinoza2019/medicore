...
| **Qué se asienta como sexo cuando no es determinable** | El numeral 5.9 de la NOM-004 lo exige en toda nota, y los instructivos SEUL de Urgencias **2024** (verificados 2026-08-28) definen Sexo como 1 Hombre / 2 Mujer / 3 Intersexual con reglas de documento/exploración/fenotipo, **sin** centinela de desconocimiento. Análisis sexo vs género: [`14-sexo-genero-dgis.md`](14-sexo-genero-dgis.md). | Instrucción oficial de desconocimiento **sigue sin localizarse**, o criterio del cliente. Interno: `no_determinado` (doc 08 §5.2) |
