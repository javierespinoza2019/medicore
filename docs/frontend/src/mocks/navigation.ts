...
export const navigationItems: NavItem[] = [
  ...
  },
  {
    ...
    path: '',
    children: [
      { key: 'hl7-fhir', label: 'HL7 FHIR', icon: 'ri-share-circle-line', path: '/app/hl7-fhir', subtitle: 'Interoperabilidad clinica FHIR R4 - Mensajes y configuracion de servidores' },
    ],
  },
  {
    key: 'normatividad',
...
export const branches = [
  { id: 'suc1', nombre: 'Clínica Central - CDMX' },
  { id: 'suc2', nombre: 'Sucursal Norte - CDMX' },
  { id: 'suc3', nombre: 'Sucursal Sur - CDMX' },
];