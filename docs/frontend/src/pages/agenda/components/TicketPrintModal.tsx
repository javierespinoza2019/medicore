...
export default function TicketPrintModal({ appointment, isOpen, onClose }: TicketPrintModalProps) {
  ...
  const doctor = useMemo(() => doctors.find((d) => d.id === appointment.doctorId), [appointment.doctorId]);
          ...
          <div id="ticket-print-wrapper" className="bg-background-50 print:bg-white print:text-black">
            ...
            <div className="px-6 py-6">
              ...
              <div className="mb-3">
                ...
                {doctor && <p className="text-2xs text-foreground-400 print:text-gray-500">Cédula: {doctor.cedula}</p>}
              </div>
