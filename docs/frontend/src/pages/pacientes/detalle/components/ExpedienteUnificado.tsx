                      ...
                      <div className="flex items-center gap-2 flex-wrap">
                        ...
                        {entry.triage && (
                          <span className={`text-2xs font-semibold px-1.5 py-0.5 rounded-full ${
                            entry.triage.nivelUrgencia === 'rojo' ? 'bg-red-100 text-red-700' :
                            entry.triage.nivelUrgencia === 'naranja' ? 'bg-orange-100 text-orange-700' :
                            entry.triage.nivelUrgencia === 'amarillo' ? 'bg-amber-100 text-amber-700' :
                            'bg-emerald-100 text-emerald-700'
                          }`}>
                            {entry.triage.nivelUrgencia === 'rojo' ? 'Emergencia' :
                             entry.triage.nivelUrgencia === 'naranja' ? 'Urgencia' :
                             entry.triage.nivelUrgencia === 'amarillo' ? 'Preferente' : 'No urgente'}
                          </span>
                        )}
                        ...
                        {entry.urgencia && (
                          <span className={`text-2xs font-semibold px-1.5 py-0.5 rounded-full ${
                            urgenciaConfig[entry.urgencia.nivelUrgencia].bg
                          } ${urgenciaConfig[entry.urgencia.nivelUrgencia].text}`}>
