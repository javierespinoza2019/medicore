  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      if (found) {
        ...
        setError('Usuario o contrasena incorrectos. Verifica tus credenciales.');
      }
      setLoading(false);
    }, 600);
  };
      ...
      <div className="hidden lg:flex lg:w-[480px] xl:w-[560px] relative overflow-hidden bg-primary-900">
        ...
        <div className="relative z-10 flex flex-col justify-between p-12 xl:p-16 w-full">
          <div>
            ...
            <p className="mt-3 text-lg text-white/70 font-heading">
              Plataforma Integral de Gestion Clinica
            </p>
            <p className="mt-8 text-sm text-white/50 leading-relaxed max-w-sm">
          ...
          <div className="space-y-6">
            ...
            <div className="flex gap-4">
              <span className="px-3 py-1.5 text-2xs font-medium text-white/60 bg-white/5 rounded-full border border-white/10">HIPAA Ready</span>
              <span className="px-3 py-1.5 text-2xs font-medium text-white/60 bg-white/5 rounded-full border border-white/10">NOM-024-SSA3</span>
              <span className="px-3 py-1.5 text-2xs font-medium text-white/60 bg-white/5 rounded-full border border-white/10">ISO 27001</span>
            </div>
            <p className="text-2xs text-white/30">&copy; 2026 MediCore. Todos los derechos reservados.</p>
          </div>
        </div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-12">
        <div className="w-full max-w-[440px]">
          ...
          <div className="lg:hidden mb-10 text-center">
            ...
            <p className="text-sm text-foreground-500 mt-1">Plataforma de Gestion Clinica</p>
          </div>

          <div className="mb-8">
            <h2 className="text-2xl font-bold text-foreground-900 font-heading">Iniciar Sesion</h2>
            <p className="text-sm text-foreground-500 mt-1.5">Ingresa tus credenciales para acceder al sistema</p>
          </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-3 py-2.5 bg-background-50 border border-secondary-200 rounded-lg text-sm text-foreground-900 placeholder:text-foreground-400 outline-none focus:border-primary-400 focus:ring-2 focus:ring-primary-100 transition-base"
                />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-10 py-2.5 bg-background-50 border border-secondary-200 rounded-lg text-sm text-foreground-900 placeholder:text-foreground-400 outline-none focus:border-primary-400 focus:ring-2 focus:ring-primary-100 transition-base"
                />
                <button
                  type="button"
                  onClick={() => setShowPassword(!showPassword)}
                  className="absolute right-3 top-1/2 -translate-y-1/2 w-4 h-4 flex items-center justify-center text-foreground-400 hover:text-foreground-600 cursor-pointer"
                >
