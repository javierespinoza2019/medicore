...
import { urgenciasMock, type Urgencia } from './urgencias';
import { legacyMockTriageSortIndex } from '@/utils/legacyMockTriagePresentation';
...
export const urgenciasActivasDelDia: Urgencia[] = urgenciasMock
  ...
  .sort((a, b) => legacyMockTriageSortIndex(a.nivelUrgencia) - legacyMockTriageSortIndex(b.nivelUrgencia));
