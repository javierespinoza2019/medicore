export type UserRole = 'admin' | 'medico' | 'recepcion' | 'enfermeria' | 'caja' | 'farmacia' | 'laboratorio' | 'directivo' | 'trabajo_social';
...
export const usuarios: User[] = [
  ...
  // ── Trabajo social Clínica Central ──
  {
    id: 'u-ts1',
    nombre: 'Gabriela',
