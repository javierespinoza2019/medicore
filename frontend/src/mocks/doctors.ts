...
/**
 * Ids alineados con el seed sintético de Dev (`HealthcareProfessionalId`).
 * Así el filtro por médico de la sesión (fail closed) puede contrastarse contra
 * los mocks sin inventar un `doctorId` distinto al del servidor.
 */
export const DOCTOR_ALEJANDRO_ID = '66666666-6666-6666-6666-666666660001';
export const DOCTOR_PATRICIA_ID = '66666666-6666-6666-6666-666666660002';

export const doctors: Doctor[] = [
  {
    id: DOCTOR_ALEJANDRO_ID,
