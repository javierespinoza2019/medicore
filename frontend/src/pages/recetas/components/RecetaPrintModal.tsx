...
interface RecetaPrintModalProps {
  /** Vista de receta (API PrescriptionDto mapeada o legado estructuralmente compatible). */
  receta: RecetaView;
  isOpen: boolean;
  onClose: () => void;
  /** Nombre de sucursal observado; vacío si aún no hay dato (no se inventa). */
  sucursalNombre?: string;
}

export default function RecetaPrintModal({
  receta,
  isOpen,
  onClose,
  sucursalNombre = '',
}: RecetaPrintModalProps) {
  const sucursalLabel = sucursalNombre.trim() || 'Sucursal no capturada';
              ...
              <div className="flex items-start justify-between gap-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-foreground-500 print:text-gray-600">{sucursalLabel}</p>
                  </div>
                </div>
                <div className="text-right">
                  <p className="text-2xs text-foreground-400 print:text-gray-500">
                    Domicilio y contacto: según establecimiento capturado en el sistema
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="px-10 py-8 mt-4 print:mt-8">
              <div className="flex justify-end">
                <div className="text-center">
                  ...
                  <p className="text-sm font-semibold text-foreground-900 print:text-black">{receta.doctorName}</p>
                  <p className="text-xs text-foreground-500 print:text-gray-600">Médico</p>
