...
/**
 * Modal de impresión legado del prototipo (mocks).
 * La pantalla viva de triage (`pages/triage/page.tsx`) ya no lo usa.
 * El mapa fijo rojo/naranja/amarillo/verde **no** es escala de producto (doc 06 §63).
 * No reintroducir estos códigos en UI clínica; usar escala efectiva vía API.
 */
